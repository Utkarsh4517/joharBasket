...
import 'package:johar/features/search/ui/pooja_search_page.dart';

class PoojaAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  State<PoojaAppBar> createState() => _CosmeticCustomAppbarState();

  @override
  Size get preferredSize => const Size.fromHeight(160);
}

class _CosmeticCustomAppbarState extends State<PoojaAppBar> {
  @override
  void initState() {
    getUserName();
    super.initState();
          ...
          children: [
            ...
            GestureDetector(
                onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => PoojaSearchPage(
