...
class ProfileProductOrderCard extends StatefulWidget {
  final ProfileOrderLoadedSuccessState successState;
  final int indexU;
  final int index;
  const ProfileProductOrderCard({
  ...
  @override
  State<ProfileProductOrderCard> createState() =>
      _ProfileProductOrderCardState();
}

class _ProfileProductOrderCardState extends State<ProfileProductOrderCard> {
  @override
