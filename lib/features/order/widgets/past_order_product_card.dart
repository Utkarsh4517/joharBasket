...
class PastOrderProductCard extends StatefulWidget {
  final PastOrderLoadedSuccessState successState;
  final int indexU;
  final int index;
  const PastOrderProductCard({
    required this.index,
  ...
  @override
  State<PastOrderProductCard> createState() => _PastOrderProductCardState();
}

class _PastOrderProductCardState extends State<PastOrderProductCard> {
  @override
